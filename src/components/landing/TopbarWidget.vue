...
<template>
    <a class="flex items-center" href="#" @click="smoothScroll('hero')">
        <svg
            viewBox="0 0 54 40"
            fill="none"
    ...
    <div
        class="sticky items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex lg:static w-full right-0 top-full px-12 lg:px-0 z-20 rounded-border"
    >
        <ul
        ...
        >
            ...
            <li>
                <a
                    @click.prevent="smoothScroll('highlights')"
                    class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl"
                >
                    <span>Location</span>
                </a>
