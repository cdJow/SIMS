...
<template>
    ...
    <div
        class="sticky top-0 items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full right-0 top-full px-12 lg:px-0 z-20 rounded-border"
    >
        <ul
